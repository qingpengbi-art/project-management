      ...
      >
            ...
            <el-form-item prop="password">
              <div class="field-group">
                <label class="field-label">
                  密码
                  <transition name="caps-fade">
                    <span v-if="capsLockOn" class="caps-warning">
            ...
            <el-form-item class="form-submit">
              <button
                type="button"
                class="submit-btn"
                :class="{ 'is-loading': loading, 'shake': loginError }"
                :disabled="loading"
                @click="handleLogin"
              >
...
.caps-fade-enter-active,
.caps-fade-leave-active {
  transition: all 0.3s ease;
}

.caps-fade-enter-from,
.caps-fade-leave-to {
  opacity: 0;
...
:deep(.el-input__wrapper.is-error) {
  ...
  animation: input-error-shake 0.5s ease;
}
